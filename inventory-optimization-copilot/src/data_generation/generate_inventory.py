...
PRODUCT_CATALOG: list[tuple[str, str, str, float]] = [
    ("Tires", "All-Season", "Tour Plus 215/60R16", 89.99),
    ("Tires", "Performance", "Sport Grip 245/40R18", 124.50),
    ("Tires", "Winter", "SnowTrack 205/55R16", 98.75),
    ("Tires", "Commercial", "Fleet HD 225/75R16", 142.00),
    ...
    ("Batteries", "Automotive", "PowerStart 24F", 119.99),
    ("Batteries", "AGM", "AGM 47H6", 189.00),
